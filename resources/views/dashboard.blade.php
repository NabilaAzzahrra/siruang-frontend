        ...
        function updateRoom(id, nama_ruang, id_sesi) {
            ...
            modalContent.innerHTML = `
                    ...
                    <div class="lg:mb-5 mb-2 w-full">
                        ...
                        <select id="mata_kuliah" class="js-example-placeholder-single js-states lg:w-[585px] w-[345px] form-control m-6" name="mata_kuliah" data-placeholder="Pilih Mata Kuliah">
