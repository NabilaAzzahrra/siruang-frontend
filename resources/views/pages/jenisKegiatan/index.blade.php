<x-app-layout>
                                ...
                                <div class="p-4 rounded-xl">
                                    <div class="mb-5">
                                        ...
                                        <input type="text" name="jenis_kegiatan"
                                            ...
                                            placeholder="Masukan Jenis Kegiatan disini ..." required />
                                    </div>
                                    <button type="submit"
                        ...
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <div class="flex justify-center">
                                <div class="p-12" style="width:100%;  overflow-x:auto;">
                                    <table class="table table-bordered" id="jenis-kegiatan-datatable">
                                        <thead>
                                            <tr>
                                                <th class="w-7">No.</th>
                                            ...
                                            @foreach ($data as $d)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <button
                                                                onclick="return dataDelete('{{ $d->id }}','{{ $d->kegiatan }}')"
                    ...
                    <div class="flex flex-col  p-4 space-y-6">
                        <div class="mb-5">
                            ...
                            <input type="text" id="jenis_kegiatan" name="jenis_kegiatan"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Masukan Jenis Kegiatan disini...">
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#jenis-kegiatan-datatable').DataTable(); // Inisialisasi sederhana
        });
    </script>
    <script>
        const editSourceModal = (button) => {
            ...
            let url = "{{ route('jenisKegiatan.update', ':id') }}".replace(':id', id);
            console.log(url);
            let status = document.getElementById(modalTarget);
            document.getElementById('title_source').innerText = `UPDATE JENIS KEGIATAN ${kegiatan}`;
            document.getElementById('jenis_kegiatan').value = kegiatan;
        ...
        const dataDelete = async (id, kegiatan) => {
            let tanya = confirm(`Apakah anda yakin untuk menghapus jenis kegiatan ${kegiatan} ?`);
            if (tanya) {
                await axios.post(`/jenisKegiatan/${id}`, {
                        '_method': 'DELETE',
