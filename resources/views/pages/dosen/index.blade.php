<x-app-layout>
                                ...
                                <div class="p-4 rounded-xl">
                                    <div class="mb-5">
                                        ...
                                        <input type="text" name="dosen"
                                            ...
                                            placeholder="Masukan Dosen disini ..." required />
                                    </div>
                                    <button type="submit"
                                            ...
                                            @foreach ($data as $d)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <button
                                                                onclick="return dataDelete('{{ $d->id }}','{{ $d->dosen }}')"
            ...
            <div class="w-full md:w-1/4 relative bg-white rounded-lg shadow mx-5">
                ...
                <form method="POST" id="formSourceModal">
                    ...
                    <div class="flex flex-col  p-4 space-y-6">
                        <div class="mb-5">
                            <label for="text" class="block mb-2 text-sm font-medium text-gray-900">Dosen</label>
                            <input type="text" id="dosen" name="dosen"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="Masukan Dosen disini...">
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#dosen-datatable').DataTable(); // Inisialisasi sederhana
        });
    </script>
    <script>
        const editSourceModal = (button) => {
            ...
            document.getElementById('title_source').innerText = `${dosen}`;
        ...
        const dataDelete = async (id, hari) => {
            let tanya = confirm(`Apakah anda yakin untuk menghapus dosen ${hari} ?`);
            if (tanya) {
